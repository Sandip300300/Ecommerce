        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                @foreach ($carts as $cart)
                    ...
                    <tr>
                        <td> <img width="60" src="{{ asset('/post/' . $cart->product->image) }}" alt="" /></td>

                        <td>{{ $cart->product->name }}</td>
                        <td>
                            <div class="input-append"><input class="span1" style="max-width:34px" placeholder="1"
                                    id="appendedInputButtons" value="{{ $cart->qty }}" type="number"><button class="btn"
                        ...
                        <td><input type="checkbox" name="select_product[]" card-id="{{ $cart->id }}"> </td>
                ...
                <tr>
                    ...
                    <td> <button class="buy_product "> Buy </button></td>
                </tr>
            </tbody>
        </table>

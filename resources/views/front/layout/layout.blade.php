...
<!-- Bootstrap 5 style -->
<link id="callCss" rel="stylesheet" href="{{asset('assete/bootstrap-5.0.2/css/bootstrap.min.css')}}" media="screen"/>


<!-- Bootstrap style -->
    <link id="callCss" rel="stylesheet" href="{{asset('themes/bootshop/bootstrap.min.cs')}}s" media="screen"/>
...
<!-- Placed at the end of the document so the pages load faster ============================================= -->
    ...
    <script src="{{asset('assete/bootstrap-5.0.2/js/bootshop.min.js')}}"></script>

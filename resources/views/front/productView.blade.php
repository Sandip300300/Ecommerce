...
<div class="span9">
	...
	<div class="row">
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="{{ asset('/post/' . $product->image) }}" style="width:100%" alt=""/>
            </a>
			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <div class="control-group">
                    ...
                    @else
                    <button  class="btn btn-large btn-primary pull-right"><a style="color: white; text-decoration:none;" href="{{route('user.login')}}" > Add to cart <i class=" icon-shopping-cart"></i></a></button>
                    @endif
                </form>
				...
				<hr class="soft"/>
				<h4>{{$product->ProductDetails->total_items}}</h4>
		...
		<hr class="soft"/>
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.html"><img src="{{ asset('/post/' .  $related_product->image) }}" alt=""/></a>
						<div class="caption">
						  <h5>{{$related_product->name}}</h5>
						  <p>
							Lorem Ipsum is simply dummy text.
						  </p>
						  <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">&euro;{{$related_product->name}}</a></h4>
						</div>
					  </div>
					</li>
